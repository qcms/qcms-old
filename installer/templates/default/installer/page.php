...
<head>
    ...
    <link href="/{constant:DIRNAME_INSTALLER}/s/framework.css" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="/{constant:DIRNAME_INSTALLER}/js/html5.js"></script>
    <![endif]-->

    <link type="text/css" href="/{constant:DIRNAME_INSTALLER}/s/smoothness/jquery-ui-1.8.20.custom.css" rel="stylesheet" />
    <script type="text/javascript" src="/{constant:DIRNAME_INSTALLER}/js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="/{constant:DIRNAME_INSTALLER}/js/jquery-ui-1.8.20.custom.min.js"></script>

    <link type="text/css" href="/{constant:DIRNAME_INSTALLER}/s/style.css" rel="stylesheet" />

    <!-- elRTE -->
    <link rel="stylesheet" href="/{constant:DIRNAME_INSTALLER}/e/css/elrte.min.css" type="text/css" media="screen">
    <script src="/{constant:DIRNAME_INSTALLER}/e/js/elrte.min.js"                  type="text/javascript"></script>
    <script src="/{constant:DIRNAME_INSTALLER}/e/js/i18n/elrte.ru.js"              type="text/javascript"></script>

    <!-- elFinder -->
    <script src="/{constant:DIRNAME_INSTALLER}/e/js/elfinder.min.js" type="text/javascript"></script>
    <script src="/{constant:DIRNAME_INSTALLER}/e/js/i18n/elfinder.ru.js" type="text/javascript"></script>
    <link rel="stylesheet" href="/{constant:DIRNAME_INSTALLER}/e/css/elfinder.css" type="text/css" media="screen" title="no title">

    <!-- jquery.treeview -->
    <script type="text/javascript" src="/{constant:DIRNAME_INSTALLER}/js/jquery.treeview.js"></script>
    <script type="text/javascript" src="/{constant:DIRNAME_INSTALLER}/js/jquery.cookie.js"></script>
    <link type="text/css" href="/{constant:DIRNAME_INSTALLER}/s/jquery.treeview.css" rel="stylesheet" />

    <script src="/{constant:DIRNAME_INSTALLER}/js/swfobject.js" type="text/javascript"></script>
...
<div class="g">
    <div class="g-row gray p5px header">
        <header>
            {variable:admin_current_name_custom}
