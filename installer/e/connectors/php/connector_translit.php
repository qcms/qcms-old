...
include_once dirname(__FILE__).DIRECTORY_SEPARATOR.'elFinder.translit.class.php';
...
{
	$imagebasedir .= "/".$_GET["table"];
	$imagebaseurl .= "/".$_GET["table"];
	...
	{
		$imagebasedir .= "/".$_GET["identity"]."/";
		$imagebaseurl .= "/".$_GET["identity"]."/";
		if(!file_exists($imagebasedir))
		{
			mkdir($imagebasedir);
		}
...
$opts = array(
	'root'            => $imagebasedir,                       // path to root directory
	'URL'             => $imagebaseurl, // root directory URL
