...
$page_module_types = array(
    "10" => array("Текст"),
    "20" => array("Текст с изображением слева"),
    "30" => array("Текст с изображением справа"),
    "40" => array("Галерея изображений"),
    "50" => array("Видео"),
    "60" => array("Звук"),
    "70" => array("Файл с описанием"),

    "100" => array("Разделитель"),
);
    ...
    "page_module" => array(
        ...
        "admin" => array(
            "list" => array(
                ...
                "name" => array("Список модулей страницы"),
            ),
            "edit" => array(
                "url_template" => "page_module_edit.php?id=[id]",
                "file" => "page_module_edit.php",
                "name" => array("Редактирование модуля страницы"),
            ),
            "delete" => array(
                "url_template" => "page_module_edit.php?id=[id]&action=delete",
                "file" => "page_module_edit.php",
                "name" => array("Удалить"),
            ),
            "up" => array(
                "url_template" => "page_module_edit.php?id=[id]&action=up",
                "file" => "page_module_edit.php",
                "name" => array("Вверх")
            ),
            "down" => array(
                "url_template" => "page_module_edit.php?id=[id]&action=down",
                "file" => "page_module_edit.php",
                "name" => array("Вниз")
            ),
        ),
        ...
        "fields" => array(
            ...
            "page_module_name" => array(
                "name" => array("Заголовок"),
                "help" => array("Заголовок модуля"),
            ...
            "page_module_video" => array(
                ...
                "params" => array( // параметры поля
                    ...
                    "width" => "640", // ширина (размер плеера)
                    "height" => "360", // высота (размер плеера)
                    "preview_field" => "page_module_preview", // поле для превью в плеере
                )
            ),
            "page_module_sound" => array(
                "name" => array("Звук"),
                "type" => "sound", // тип поля string, password, text, number, datetime, checkbox, select, image, sound, video, file
                "params" => array( // параметры поля
                    "length" => "30", // длина поля для полей типа string, number
                    "nolang" => "true",
                )
            ),
            "page_module_file" => array(
                "name" => array("Файл"),
                "type" => "file", // тип поля string, password, text, number, datetime, checkbox, select, image, sound, video, file
                "params" => array( // параметры поля
                    "length" => "30", // длина поля для полей типа string, number
                    "nolang" => "true",
                )
